...
func TestAmountFormatter_CurrencyDisplay(t *testing.T) {
	tests := []struct {
		...
		// {"1234.59", "USD", "de-AT", golocales.DisplaySymbol, "$\u00a01.234,59"},
		// {"1234.59", "USD", "de-AT", golocales.DisplayCode, "USD\u00a01.234,59"},
		// {"1234.59", "USD", "de-AT", golocales.DisplayNone, "1.234,59"},
		...
		{"-1234.59", "USD", golocales.DisplayNone, "(1,234.59)", en.GetLocale()},
		// {"-1234.59", "USD", "en-NL", golocales.DisplayNone, "(1.234,59)"},
		// {"-1234.59", "USD", "sr-Latn", golocales.DisplayNone, "(1.234,59)"},
	}
